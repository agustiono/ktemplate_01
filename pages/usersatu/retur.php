...
<table width="50%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="60%"><label for="kodebarang"></label>
      <input type="text" name="kodebarang" id="kodebarang" placeholder="Pilih Barang.."  onClick="window.open('<?php echo $baseurl; ?>pages/web/viewbarang.php','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');">
...
if(isset($_POST['button']))
{
	...
	if($rc==1)
	{
		...
		{
			$q=mysql_query("Insert into barang_keluar (`tgl`,`kode_barang`,`jumlah`) values ('".$newDate."','".$_POST['kodebarang']."','".$_POST['qty']."')") or die(mysql_error());
			if($q)
			{
