...
<tr >
    ...
    <td><a href="?cat=gudang&page=barangedit&id=<?php echo sha1($result['kode_barang']); ?>">Edit</a> - <a href="?cat=gudang&page=barang&del=1&id=<?php echo sha1($result['kode_barang']); ?>">Hapus</a></td>   
  </tr>
<?php
}
?>
